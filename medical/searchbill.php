        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                   ...
                   <div class="container" >
                    <form method="post">
                                        <label class="" style="font-size: 16px;position: relative;top: 108px;left: 493px;" for="">
                                <b> Search Bill Here</b>
                                  </label>
                                        ...
                                        <input type="submit" name="Search" value="Search" class="btn btn-block btn-primary" style="position: relative;top: 136px;width: 201px; left: 452px;">
...
$SEARCH= "SELECT * FROM medicalbill WHERE user_email ='$search' OR appointment_id ='$search' AND mname = '$mname'";
...
if (mysqli_num_rows($r)==0) {
  echo "<script type='text/javascript'> alert('No Data Found!!'); 
      document.location = 'searchbill.php'; </script>";
}
                                    ...
                                    <?php foreach ($sch as $sch){ ?>
                                     <div class="container" >
                                      <div class="row">
                                          ...
                                          <div class="col-lg-4">
                                              <div class="card card-margin" style="position: relative;width: 625px;top: 270px;left: 241px;height: 236px;">
                                                          ...
                                                          <div class="widget-49-title-wrapper">
                                                              ...
                                                              <div class="widget-49-meeting-info" style="overflow: hidden;">
                                                                  ...
                                                                  <span class="widget-49-pro-title"style="position: absolute;left: 113px;top: 86px;font-size: 17px; ">Appointment Date:<?php echo$sch['booking_date']; ?></span>
                                                                   ...
                                                                   <span class="widget-49-pro-title"style="position: absolute;left: 113px;top: 110px;font-size: 17px;">Hospital Name:<?php echo$sch['hname']; ?></span>
                                                                    ...
                                                                    <span class="widget-49-pro-title"style="position: absolute;left: 113px;top: 155px;font-size: 17px;">Billing Time:<?php echo$sch['time']; ?></span>
