...
if (isset($_POST['submit'])) {
  ...
  $username = $_POST['username'];
    ...
    echo "<script type='text/javascript'> alert('Please Fill All The Fields'); 
      ...
      document.location = 'medicallogin.php'; </script>";
      return;
   }
...
$login = "SELECT * FROM medical WHERE m_name = '$username' AND m_pass = '$password'";
...
elseif ($m_hname == "Ruby Hall Clinic") {
  $row=mysqli_fetch_array($result);
...
elseif ($m_hname == "Sasoon Hosiptal") {
  $row=mysqli_fetch_array($result);
  $_SESSION['username']=$username;
  echo "<script type='text/javascript'> alert('Welcome '); 
      document.location = 'viewprescription.php'; </script>";
