...
$login = "SELECT email,password FROM doctors WHERE email='$email' AND password='$password'";
...
if (mysqli_num_rows($result)==0) {
  ...
  echo "<script type='text/javascript'> alert('Welcome Doctor!!'); 
      document.location = 'today.php'; </script>";
...
<div class="login-form">
    <form  method="post" style="position: relative;top: 114px;">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="email" placeholder=" Enter Mail Id" value="<?php echo $email;?>" >
        </div>   
		    <div class="form-group">
        ...
        <p><a href="docfp.php">Forgot Password?</a></p>
    </form>
