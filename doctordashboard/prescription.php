<?php
$myCountryErr=$myCountry=$morning=$afternoon=$night=$quantity=$quantityErr="";
...
if(isset($_POST['submit'])){
                        ...
                        if (empty($_POST["quantity"])) {  
                         $quantityErr = "Enter Quantity";
                        } else {  
                        $quantity = input_data($_POST["quantity"]); 
                        if (!preg_match ("/^[0-9]*$/", $quantity) ) {  
                            $quantityErr = "Only numeric value is allowed.";
                        }
                        }
...
if(empty($myCountryErr) && empty($quantityErr)){
$insert = "INSERT INTO prescription (appointment_id,m_name,morning,afternoon,night,quantity) VALUES ('$appointment_id','$myCountry','$morning','$afternoon','$night','$quantity')";
      ...
      <div class="panel">
        ...
        <div class="panel-body bio-graph-info">
                    ...
                    <div class="form-group mb" style="">
                     ...
                     <div class="form-group mb"<?php echo (!empty($myCountryErr)) ? 'has-error' : ''; ?>>
                        <label for="select" style="display: inline-block;font-size: 14px;color: black;position: relative;    bottom: 125px;left: 279px;">
                            Quantity
                        </label>
                         <input class="form-control" name="quantity" id="quantity" style="position: relative;width: 167px;   bottom: 155px;left: 344px;">
                              <span class="help-block" style="color:red;position: relative;bottom: 153px;left: 345px;">
            ...
            <div class="panel-body" style="position: relative; width: auto; overflow: auto;">
                      ...
                      ?>
                        ...
                        <form method="post">
                            ...
                            <div class="form-group form-group-lg" >
                                  <label class="control-label col-sm-2 requiredField" for="description" style="color:black; position: relative; top: -64px;">
                                   ...
                                   <div class="col-sm-10">
                                    <textarea for="description" name="description" rows="5" cols="70" style="border: solid #337Ab7 1px;position: relative;top: -62px;left: -23px; "></textarea>
                                    <input type="hidden" id="appointment_id" name="appointment_id" value="<?php echo $_POST['appointment_id']? $_POST['appointment_id']:''; ?>">
                       ...
                       if(isset($_POST['done'])){
                        ...
                        $queryd= mysqli_query($conn,"INSERT INTO description (appointment_id,description) values ('$appointment_id','$description')");
