...
$prescription = mysqli_query($conn,"SELECT * FROM prescription WHERE appointment_id = '$appointment_id' ");

$row=mysqli_fetch_array($prescription);
...
$appointment = mysqli_query($conn,"SELECT * FROM completeapp WHERE user_email='$var' AND appointment_id = '$appointment_id' ");
