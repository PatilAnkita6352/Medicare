                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            $results=mysqli_query($conn,"SELECT * FROM appointments WHERE doctor_id = '$id' AND tmode = 'Walkin'");
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM appointments WHERE doctor_id = '$id' AND tmode = 'Online'");
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM confirmapp WHERE doctor_id = '$id' AND tmode = 'Home Visit'");
