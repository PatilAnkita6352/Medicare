                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> Easy Search
                                </li>
                            </ol>
                        </div>
                    </div>
                    <div class="container">
                        ...
                        <div class="row">
                          <label style="position:relative;top: 67px;left: 356px;"><h5>Enter Starting Date</h5></label>  
                        <input type="date" name="start" id="start" value="" class="form-control" required="" style="        position: relative;    width: 184px;left: 354px;top: 63px;border: 1px solid;">
                        
                        <h5 style="position: relative;width: 160px;left: 565px;    top: 22px;">To</h5>
                         <label style="    position: relative;top: -66px;left: 627px;"><h5>Enter Ending Date</h5></label>
                        <input type="date" name="end" id="end" value="" class="form-control" required=""style="    position: relative;    width: 184px;left: 618px;top: -66px;border: 1px solid;">
                       
                        <input type="submit" value="Submit"  name="submit" id="submit" label="Sign Up" class="btn btn-block btn-primary"style="position: relative;width: 160px;left: 500px; top: 10px;" >


                        <div class="panel panel-primary filterable" style="position : relative; top: 40px;">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            $results=mysqli_query($conn,"SELECT * FROM completeapp WHERE doctor_id = '$id' AND booking_date between '$start' and '$end' ");
