                ...
                <div class="container-fluid">
                    ...
                    <div class="container" style="width: fit-content;">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">List of Walkin Appointments</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="Patient Email" disabled></th>
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Booking Day" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Booking Date" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Address" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Description" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="History" disabled></th>
                            ...
                            $results=mysqli_query($conn,"SELECT * FROM appointments WHERE doctor_id = '$id' AND tmode = 'Walkin' AND booking_date = '$dt' ");
                            ...
                            while ($docRow=mysqli_fetch_array($results)) {
                                ...
                                echo "<tr>";
                                    ...
                                    <input type='hidden' value='".$docRow['pname']."' name='pname'>
                                    <input type='hidden' value='".$docRow['user_email']."' name='user_email'>
                                    <button class='btn btn-primary'>view</button></a>
                                            </td>";
                                    echo"</form>";
                                
                                     echo "<form action = 'prescription.php' method='POST'>";
                                    echo "<td class='text-center'><input type='hidden' value='".$docRow['appointment_id']."' name='appointment_id'><button class='btn btn-primary'>Prescribe</button></a>
                                            </td>";
                                    echo"</form>";
                                echo "<form action = 'completeapp.php' method='POST'>";
                                    echo "<td class='text-center'><input type='hidden' value='".$docRow['appointment_id']."' name='appointment_id'><button class='btn btn-success'>Done</button></a>
                                            </td>";
                                    echo"</form>";
                            } 
                                echo "</tr>";
                    ...
                    <div class="container" style="width: fit-content;">
                     ...
                     <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM appointments WHERE doctor_id = '$id' AND tmode = 'Online' AND booking_date = '$dt' ");
                    ...
                    <div class="container" style="width:fit-content;">
                     ...
                     <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM confirmapp WHERE doctor_id = '$id' AND tmode = 'Home Visit' AND booking_date = '$dt'");
                            ...
                            while ($docRow=mysqli_fetch_array($results)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo"</form>";
                                  echo "<form action = 'hprescription.php' method='POST'>";
                                    echo "<td class='text-center'><input type='hidden' value='".$docRow['appointment_id']."' name='appointment_id'><button class='btn btn-primary'>Prescribe</button></a>
                                            </td>";
                                    echo"</form>";
                                echo "<form action = 'hcomplete.php' method='POST'>";
                                    echo "<td class='text-center'><input type='hidden' value='".$docRow['appointment_id']."' name='appointment_id'><button class='btn btn-success'>Done</button></a>
                                            </td>";
                                    echo"</form>";
                            } 
