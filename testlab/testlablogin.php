...
if (isset($_POST['submit'])) {
  ...
  $username = $_POST['username'];
    ...
    echo "<script type='text/javascript'> alert('Please Fill All The Fields'); 
      document.location = 'testlablogin.php'; </script>";
      return;
   }
...
$login = "SELECT * FROM pathology WHERE p_name = '$username' AND p_pass = '$password'";
...
elseif ($p_hname == "Ruby Hall Clinic") {
  $row=mysqli_fetch_array($result);
  $_SESSION['username']=$username;
  echo "<script type='text/javascript'> alert('Welcome '); 
      document.location = 'viewtest.php'; </script>";
 
}
elseif ($p_hname == "Sassoon Hospital") {
  $row=mysqli_fetch_array($result);
  $_SESSION['username']=$username;
  echo "<script type='text/javascript'> alert('Welcome '); 
      document.location = 'viewtest.php'; </script>";
