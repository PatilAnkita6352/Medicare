    ...
    <body>
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
               ...
               <?php
               include_once('testlabnavbar.php');
               ?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                   ...
                   <div class="container" >
                    <form method="post">
                                        <label class="" style="font-size: 16px;position: relative;top: 108px;left: 483px;" for="">
                                                          ...
                                                          <div class="widget-49-title-wrapper">
                                                              ...
                                                              <div class="widget-49-meeting-info" style="overflow: hidden;">
                                                                  ...
                                                                  <span class="widget-49-pro-title"style="position: absolute;left: 113px;top: 86px;font-size: 17px; ">Appointment Date:<?php echo$sch['booking_date']; ?></span>
                                                                   ...
                                                                   <span class="widget-49-pro-title"style="position: absolute;left: 113px;top: 135px;font-size: 17px;">Hospital Name:<?php echo$sch['hname']; ?></span>
                                                                    <span class="widget-49-pro-title"style="position: absolute;left: 113px;top: 110px;font-size: 17px;">Treatment Mode:<?php echo$sch['tmode']; ?></span>
