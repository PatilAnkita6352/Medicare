...
$appointment = "SELECT * FROM testlabbill WHERE user_email='$var' Order by appointment_id DESC";
                                              ...
                                              <div class="card card-margin" style="position: relative;width: 495px;top:70px;left: 407px;height: 236px;">
                                                  ...
                                                  <div class="card-body pt-0">
                                                      <div class="widget-49">
                                                          ...
                                                          <form method='POST' action="labbill.php" style="position: absolute;top: 173px;left: 352px;">
