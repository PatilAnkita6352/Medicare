...
$appointment = "SELECT * FROM rejectapp WHERE user_email='$var'";
...
?> 
               ...
               <div class="row" id="userCardContainer">
                 ...
                 <div data-reactroot=""class="main-container bg-grey"style="overflow:scroll;">
                                                    <?php
                                     foreach ($row as $row){ ?>
                                   <div class="container" >
                                      <div class="row"style="top:-170px;position: relative; left: 85px;">
                                          <div class="col-lg-4">
