...
$appointment = "SELECT * FROM bill WHERE appointment_id = '$appointment_id' ";
          ...
          <div class="panel-body bio-graph-info">
              <div class="row" style="position: relative;left: 77px;">
                  ...
                  <div class="panel"  style="   position: relative;top: 253px;right: 77px;height: 166px;">
                     ...
                     <table class="table table-hover table-bordered" style="position: relative;bottom: 194px;">
                            <thead>
                                <tr class="filters">
                                   <th><input type="text" class="form-control" placeholder="List" disabled></th>
                                   <th><input type="text" class="form-control" placeholder="Charges" disabled></th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
