...
$images='';
$resultst=mysqli_query($conn,"SELECT * FROM prescription WHERE appointment_id='$appointment_id' ");
 



$appointment = "SELECT * FROM medicalbill WHERE appointment_id = '$appointment_id' ";
                                    ...
                                    $data.='<p><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$row['quantity'].'</td></p>';
                                        $resultss=mysqli_query($conn,"SELECT * FROM medicines WHERE med_name='$pmname' ");
                                         while ($r=mysqli_fetch_array($resultss)) {
                                             $price=$r['price'] * $row['quantity'];
                                            $data.='<p><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$price.'</td></p>';
