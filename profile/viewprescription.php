...
<?php
$prescription = "SELECT * FROM prescription WHERE appointment_id = '$appointment_id' ";
$results=mysqli_query($conn,$prescription) or die(mysqli_error($conn));
...
$resultd=mysqli_query($conn,$appointment) or die(mysqli_error($conn));
...
<div class="panel panel-primary filterable" style="position: relative;
  ...
  <div class="panel-heading">
                      ...
                      $description='';
                       ...
                       ?>
                        <div class="description"style="position: relative;top: 59px;left: 10px;">
                        <lable style="font-size: 17px;color: black;"><b>Description:-</b></lable><br>
