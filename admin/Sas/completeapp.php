...
<div class="panel panel-primary filterable">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">List of Completed Appointments</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Completed By" disabled></th>                                 
                                </tr>
                            </thead>
                            
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM completeapp WHERE hname='Sassoon Hospital'");
                            ...
                            while ($docRow=mysqli_fetch_array($results)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>" . $docRow['complete_time'] . "</td>";
