...
$pi=mysqli_query($conn,"SELECT COUNT(appointment_id) AS yj FROM completeapp WHERE hname = 'Sassoon Hospital' ");
...
$r=mysqli_query($conn,"SELECT COUNT(username) AS unm FROM doctors WHERE hname = 'Sassoon Hospital'");
...
$results=mysqli_query($conn,"SELECT COUNT(appointment_id) AS tcb FROM appointments WHERE hname = 'Sassoon Hospital' AND booking_date = '$dt' ");
$docRow=mysqli_fetch_array($results);

?>
                        <div class="col-md-4">
                          <div class="card-counter info">
                           <i class="fa fa-file-text"  aria-hidden="true"></i>
                            <span class="count-numbers"><?php echo $docRow['tcb']; ?></span>
                            <span class="count-name">Today's Appointment</span>
                          </div>
                        </div>
...
$ka=mysqli_query($conn,"SELECT COUNT(appointment_id) AS ysj FROM completeapp WHERE hname = 'Sassoon Hospital' AND tmode = 'Online' ");
...
$ch=mysqli_query($conn,"SELECT COUNT(appointment_id) AS yjr FROM completeapp WHERE hname = 'Sassoon Hospital' AND tmode = 'Walkin' ");
...
<?php  
$u=mysqli_query($conn,"SELECT COUNT(appointment_id) AS me FROM completeapp WHERE hname = 'Sassoon Hospital' AND tmode = 'Home Visit' ");
