...
<html lang="en">
    <head>
        ...
        <title>Visits Applications</title>
        <!-- Bootstrap Core CSS -->
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">List of Home Visits Applications</h3>
                ...
                <div class="panel-body">
                            ...
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Description" disabled></th>
                                     ...
                                     <th><input type="text" class="form-control" placeholder="Decline" disabled></th>

                                </tr>
                            </thead>
                            
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM appointments WHERE hname='Sassoon Hospital' AND tmode = 'Home Visit' ");
                        ...
                        echo "<tr>";
                            ...
                            echo "<form action = 'confirmapp.php' method='POST'>";
                            echo "<td class='text-center'><input type='hidden' value='".$docRow['appointment_id']."' name='appointment_id'><button class='btn btn-primary'>Accept</button>
                                </td>";
                            echo "</form>";
                            echo "<form action = 'rejectapp.php' method='POST'>";
                            echo "<td class='text-center'><input type='hidden' value='".$docRow['appointment_id']."' name='appointment_id'><button class='btn btn-danger'>Reject</button></a>
                                </td>";
                            echo"</form>";
                    } 
                                echo "</tr>";
