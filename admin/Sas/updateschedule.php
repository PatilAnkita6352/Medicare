                          ...
                          if(isset($_POST['search'])){
                              ...
                              <div class="form-group form-group-lg">
                               ...
                               <div class="form-group form-group-lg">
                                ...
                                <div class="col-sm-10">
                                 <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                  ...
                                  <input class="form-control" id="wstarttime[]" name="wstarttime[]" type="text" value="<?php  echo $row['wstarttime'];?>"required>
                                 </div>
                                </div>
                               </div>
                               ...
                               <div class="form-group form-group-lg">
                                ...
                                <div class="col-sm-10">
                                 <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                  ...
                                  <input class="form-control" id="wendtime[]" name="wendtime[]" type="text" value="<?php  echo $row['wendtime'];?>" required>
                                 </div>
                                </div>
                               </div>
                               ...
                               Number of Slots For The Appointment's
                                ...
                                <div class="col-sm-10">
                                  <input class="form-control" id="wslots[]" name="wslots[]" type="text" value="<?php  echo $row['wslots'];?>" required>                           </div>
                               </div>
                              ...
                              <div class="col-sm-10">
                                <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                  ...
                                  <input class="form-control" id="ostarttime[]" name="ostarttime[]" type="text" value="<?php  echo $row['ostarttime'];?>" required>
                                 </div>
                              </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                 <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                  ...
                                  <input class="form-control" id="oendtime[]" name="oendtime[]" type="text" value="<?php  echo $row['oendtime'];?>" required >
                                 </div>
                                </div>
                               </div>
                               ...
                               <div class="form-group form-group-lg">
                                ...
                                <div class="col-sm-10">
                                  <input class="form-control" id="oslots[]" name="oslots[]" type="text" value="<?php  echo $row['oslots'];?>" required>
                                </div>
                               </div>
                               ...
                               Home Visit Appointment Start Time
                                ...
                                <div class="col-sm-10">
                                 <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                  ...
                                  <input class="form-control" id="hstarttime[]" name="hstarttime[]" type="text"value="<?php echo $row['hstarttime'];?>"  required>
                                 </div>
                                </div>
                               </div>
                                ...
                                <div class="col-sm-10">
                                 <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                  ...
                                  <input class="form-control" id="hendtime[]" name="hendtime[]" type="text" value="<?php  echo $row['hendtime'];?>"required>
                                 </div>
                                </div>
                               </div>
                               ...
                               Number of  Slots Appointment's
                                ...
                                <div class="col-sm-10">
                                  ...
                                  value="<?php  echo $row['hslots'];?>" required>
                                </div>
                               </div>
