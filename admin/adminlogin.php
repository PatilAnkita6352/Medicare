...
$login = "SELECT * FROM admin WHERE a_name = '$username' AND a_pass = '$password'";
...
elseif ($a_hname == "Ruby Hall Clinic") {
  $row=mysqli_fetch_array($result);
  $_SESSION['username']=$username;
  echo "<script type='text/javascript'> alert('Welcome Admin'); 
      document.location = '../admin/Ruby/admin.php'; </script>";
 
}elseif ($a_hname == "KEM Hospital") {
  $row=mysqli_fetch_array($result);
  $_SESSION['username']=$username;
  echo "<script type='text/javascript'> alert('Welcome Admin'); 
      document.location = '../admin/KEM/admin.php'; </script>";

}elseif ($a_hname == "Sassoon Hospital") {
  $row=mysqli_fetch_array($result);
  $_SESSION['username']=$username;
  echo "<script type='text/javascript'> alert('Welcome Admin'); 
      document.location = '../admin/Sas/admin.php'; </script>";
    }
  }
?>
