...
<div class="panel panel-primary filterable">
                ...
                <div class="panel-body" style="position: relative; width: auto; overflow: auto;">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            $results=mysqli_query($conn,"SELECT * FROM appointments WHERE hname='KEM Hospital' AND tmode = 'Online' ");
...
<div class="panel panel-primary filterable">
                ...
                <div class="panel-body" style="position: relative; width: auto; overflow: auto;">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $resultst=mysqli_query($conn,"SELECT * FROM appointments WHERE hname='KEM Hospital' AND tmode = 'Online' AND msg = 'send'");
