...
$insert = mysqli_query($conn,"INSERT into rejectapp (appointment_id,doctor_id,doc_name,user_email,pname,tmode,age,gender,contactno,aadharno,booking_date,booking_day,address,hname,description,booking_time) 
...
if ($insert) {
        $ufetch = mysqli_query($conn,"SELECT user_email,pname FROM rejectapp WHERE appointment_id='$appointment_id'");
   ...
   $dig = mysqli_query($conn, "INSERT INTO hvrejectnotification (user_email,username,msg) VALUES('$ueml','$unme','unread')");
