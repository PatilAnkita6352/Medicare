...
$pi=mysqli_query($conn,"SELECT COUNT(appointment_id) AS yj FROM completeapp WHERE hname = 'KEM Hospital' ");
...
$r=mysqli_query($conn,"SELECT COUNT(username) AS unm FROM doctors WHERE hname = 'KEM Hospital'");
...
$results=mysqli_query($conn,"SELECT COUNT(appointment_id) AS tcb FROM appointments WHERE hname = 'KEM Hospital' AND booking_date = '$dt' ");
...
$ka=mysqli_query($conn,"SELECT COUNT(appointment_id) AS ysj FROM completeapp WHERE hname = 'KEM Hospital' AND tmode = 'Online' ");
...
$ch=mysqli_query($conn,"SELECT COUNT(appointment_id) AS yjr FROM completeapp WHERE hname = 'KEM Hospital' AND tmode = 'Walkin' ");
...
<?php  
$u=mysqli_query($conn,"SELECT COUNT(appointment_id) AS me FROM completeapp WHERE hname = 'KEM Hospital' AND tmode = 'Home Visit' ");
