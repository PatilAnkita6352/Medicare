                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Done" disabled style="    position: relative;left: 29px;"></th>                                    
                                </tr>
                            </thead>
                            
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM confirmplasma");
                            ...
                            while ($docRow=mysqli_fetch_array($results)) {
                             ...
                             $id=$docRow['id'];
                                ...
                                echo "<tr>";
                                   ...
                                   echo "<form action = 'doneplasma.php' method='POST'>";
                                    echo "<td class='text-center'><input type='hidden' value='".$id."' name='id'><button class='btn btn-success'>Done</button></a>
                                            </td>";
                                    echo"</form>";
