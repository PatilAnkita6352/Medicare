...
<html lang="en">
    <head>
        ...
        <title> Reject Home Visit Appointments</title>
        <!-- Bootstrap Core CSS -->
...
<div class="panel panel-primary filterable">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">List of Rejected Home Visits Appointments</h3>
 ...
 <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM rejectapp WHERE hname='Ruby Hall Clinic'");
