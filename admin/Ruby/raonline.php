...
<div class="panel panel-primary filterable">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">List of Online Appointments</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Generate Link" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Send Link" disabled></th>
                            ...
                            $results=mysqli_query($conn,"SELECT * FROM appointments WHERE hname='Ruby Hall Clinic' AND tmode = 'Online' ");
                            ...
                            while ($docRow=mysqli_fetch_array($results)) {
                                ...
                                if ($docRow['msg'] == "send") {
                                    ...
                                    echo "<td class='text-center'><button class='btn btn-primary'><a href = 'https://meet.google.com/' style='color:white; text-decoration:none;'>Generate Link</a></font></button>
                                            </td>";
                                    echo"</form>";
                                    echo "<form action = 'sendlink.php' method='POST'>";
                                    echo "<td class='text-center'><input type='hidden' value='".$docRow['appointment_id']."' name='appointment_id'><button class='btn btn-success'>Send Link</button></a>
                                            </td>";
                                    echo"</form>";
...
<div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="container"  style="width: fit-content;">
                        <div class="row" style="position: relative; left: -39px;">
...
<div class="panel panel-primary filterable">
                ...
                <div class="panel-body" style="position: relative; width: auto; overflow: auto;">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $resultst=mysqli_query($conn,"SELECT * FROM appointments WHERE hname='Ruby Hall Clinic' AND tmode = 'Online' AND msg = 'send'");
                            

                                  
                            while ($dRow=mysqli_fetch_array($resultst)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>" . $dRow['doc_name'] . "</td>";
                                    echo "<td>" . $dRow['user_email'] . "</td>";
                                    echo "<td>" . $dRow['pname'] . "</td>";
                                    echo "<td>" . $dRow['age'] . "</td>";
                                    echo "<td>" . $dRow['gender'] . "</td>";
                                    echo "<td>" . $dRow['contactno'] . "</td>";
                                    echo "<td>" . $dRow['aadharno'] . "</td>";
                                    echo "<td>" . $dRow['booking_day'] . "</td>";
                                    echo "<td>" . $dRow['booking_date'] . "</td>";
                                    echo "<td>" . $dRow['address'] . "</td>";
                                    echo "<td>" . $dRow['description'] . "</td>";
                                    echo "<td>" . $dRow['booking_time'] . "</td>";

                                     echo "<td class='text-center'><button  href='#myModal".$dRow['appointment_id']."' class='btn btn-danger' data-toggle='modal' >Cancel</button></a>
                                </td>";
                           echo" <div id='myModal".$dRow['appointment_id']."' class='modal fade'>
                      <div class='modal-dialog modal-login'>
                        <div class='modal-content'>
                          ...
                          <input type='hidden' value='".$dRow['appointment_id']."' name='appointment_id'>       
                              <div class='form-group'>
                                <button type='submit' name='signin' class='btn btn-danger btn-lg btn-block login-btn'>Cancel</button>
                              </div>
                            </form>
