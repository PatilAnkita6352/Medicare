...
$scheduleday=$wstarttime=$wendtime=$wslots=$hstarttime=$hendtime=$hslots=$ostarttime=$oendtime=$oslots="";

$DoctorDetailsSql = "SELECT id, username, email, hname FROM doctors WHERE hname='Ruby Hall Clinic'";
...
if (isset($_POST['submit'])) {
  ...
  { 
    ...
    $hslots=$_POST['hslots'];
    $hname='Ruby Hall Clinic';

 if (empty($id)) {
      echo "<script type='text/javascript'> alert('Enter Doctors ID'); 
      document.location = 'addschedule.php'; </script>";
     return; 
    }


    $check = "SELECT id FROM doctorschedule WHERE id='$id'";
    $result=mysqli_query($conn,$check) or die(mysqli_error($conn));
    if (mysqli_num_rows($result)) 
                {
                 echo "<script type='text/javascript'> alert('Schedule Already Exists'); 
                         document.location = 'addschedule.php'; </script>";
                  return;         
                } 
    ...
    if($query){
                echo "<script type='text/javascript'>  alert('Schedule Added Successfully'); 
                document.location = 'addschedule.php'; </script>";
                exit;
            }
            else{
                              ...
                              <div class="row">
                               <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                    <div class="form-group form-group-lg">
                                  <label class="control-label col-sm-2 requiredField" for="">
                                  Enter Doctors Name
                                  </label>
                                  <Select class="select form-control" id="id" name="id" style="position: relative; width: 395px;left: 126px;">
                                 ...
                                 <div class="form-group form-group-lg">
                                  <label class="control-label col-sm-2 " for="scheduleday">
                                   Day
                                  </label>
                                  <div class="col-sm-10">
                                 ...
                                 <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="wstarttime[]" name="wstarttime[]" type="text" >
                                   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="wendtime[]" name="wendtime[]" type="text" >
                                   </div>
                                  </div>
                                 </div>
                                 ...
                                 Number of Slots For The Appointment's
                                  ...
                                  <div class="col-sm-10">
                                    <input class="form-control" id="wslots[]" name="wslots[]" type="text" >                           </div>
                                 </div>
                               ...
                               <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="ostarttime[]" name="ostarttime[]" type="text" >
                                   </div>
                                  </div>
                                 </div>
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="oendtime[]" name="oendtime[]" type="text" >
                                   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                    <input class="form-control" id="oslots[]" name="oslots[]" type="text">
                                  </div>
                                 </div>
                                 ...
                                 Home Visit Appointment Start Time
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="hstarttime[]" name="hstarttime[]" type="text">
                                   </div>
                                  </div>
                                 </div>
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="hendtime[]" name="hendtime[]" type="text">
                                   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                  <div class="col-sm-10 col-sm-offset-2">
                                   <button class="btn btn-primary " name="submit" type="submit" style="position: relative;width: 188px; height: 36px;left: 157px;">
                                    SUBMIT
                                   </button>
