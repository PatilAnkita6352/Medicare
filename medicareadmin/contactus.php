                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Send Reply" disabled></th>
                            ...
                            while($docRow=mysqli_fetch_array($results)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>" . $docRow['subject'] . "</td>";
                                    echo "<td>" . $docRow['message'] . "</td>";
                                    
                                     echo "<form action = 'sendreply.php' method='POST'>";
                            echo "<td class='text-center'><input type='hidden' value='".$docRow['id']."' name='id'><button class='btn btn-primary'>Send Reply</button>
                                </td>";
                            echo "</form>";
                            } 
                                echo "</tr>";
