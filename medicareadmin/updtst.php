...
$mname=$price=$mnameErr=$priceErr='';
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
           ...
           if (empty($_POST["mname"])) {  
                            $mnameErr = "Test Name is required"; 
                    }else {  
                        $mname = ($_POST["mname"]); 
                    }  
                    ...
                    $check = "SELECT * FROM tests WHERE test_name='$mname'";
...
if (mysqli_num_rows($result)==0) 
                {
                    ...
                    $reg = "UPDATE tests SET price = '$price' WHERE test_name='$mname'";
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Test" disabled></th>
