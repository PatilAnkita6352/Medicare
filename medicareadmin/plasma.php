...
<div class="panel panel-primary filterable">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">List of Plasma Donars</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Donar Name" disabled></th>
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Gender" disabled></th> 
                                     <th><input type="text" class="form-control" placeholder="Weight" disabled></th>
                                      <th><input type="text" class="form-control" placeholder="Recovered Days" disabled></th>
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Eligible" disabled style="    position: relative;left: 25px;"></th>
                                    <th><input type="text" class="form-control" placeholder="Not Eligible" disabled style="    position: relative;left: 25px;"></th>                                  
                                </tr>
                            </thead>
                            
                            <?php 
                            $results=mysqli_query($conn,"SELECT * FROM plasma");
                            ...
                            while ($docRow=mysqli_fetch_array($results)) {
                             ...
                             $id=$docRow['id'];
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>" . $docRow['dname'] . "</td>";
                                    echo "<td>" . $docRow['blood'] . "</td>";                            
                                    echo "<td>" . $docRow['age'] . "</td>";
                                    echo "<td>" . $docRow['gender'] . "</td>";
                                    echo "<td>" . $docRow['weight'] . "</td>";
                                    echo "<td>" . $docRow['recovered'] . "</td>";
                                    echo "<td>" . $docRow['contactno'] . "</td>";                                
                                    echo "<td>" . $docRow['address'] . "</td>";
                                    echo "<td>" . $docRow['ptime'] . "</td>";
                                   
                                    echo "<form action = 'eligible.php' method='POST'>";
                                    echo "<td class='text-center'><input type='hidden' value='".$id."' name='id'>
                                    <input type='hidden' value='".$docRow['email']."' name='email'><button class='btn btn-success'>Eligible</button></a>
                                            </td>";
                                    echo"</form>";

                                     echo "<form action = 'noteligible.php' method='POST'>";
                                    echo "<td class='text-center'><input type='hidden' value='".$id."' name='id'>
                                    <input type='hidden' value='".$docRow['email']."' name='email'><button class='btn btn-danger'>Not Eligible</button></a>
                                            </td>";
                                    echo"</form>"; 
